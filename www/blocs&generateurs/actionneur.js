...
Blockly.Arduino["pixel_init"]=function(block){
    ...
    Blockly.Arduino.definitions_["pixel"]="dafruit_NeoPixel pixels = Adafruit_NeoPixel(" + number + ", " + pin + ", NEO_GRB + NEO_KHZ800);";
    Blockly.Arduino.setups_["pixel"]="pixel.begin();";
    Blockly.Arduino.setups_["pixel"]="pixel.clear();";
    Blockly.Arduino.setups_["pixel"]="pixel.show();";	
    return ""
};
